...
// FIXME: copied from harmony. This makes us susceptible to breakage on the most
// minor changes in the class definition.
// A much more robust approach would be to ask the harmony maintainers to put this
// class definition in inst/include, so we can LinkingTo: harmony cleanly.
class harmony { 
public:
