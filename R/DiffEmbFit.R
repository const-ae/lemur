...
DiffEmbFit <- function(data_mat, col_data, row_data,
  ...
  sce <- SingleCellExperiment(assays, colData = col_data, rowData = row_data,
                              ...
                              metadata = list(n_ambient = n_ambient, n_embedding = n_embedding,
                                              ...
                                              alignment_method = alignment_method, alignment_rotation = alignment_rotation,
                                              alignment_stretching = alignment_stretching, alignment_design_matrix = alignment_design_matrix,
                                              bootstrap_samples))
  .DiffEmbFit(sce)
}
