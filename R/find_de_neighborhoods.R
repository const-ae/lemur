...
#' @param de_mat the matrix with the differential expression values
...
#'
#' @export
find_de_neighborhoods <- function(fit, de_mat, counts = NULL, group_by, contrast, design = fit$design,
