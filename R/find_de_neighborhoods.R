...
#' @param group_by defines how the pseudobulks are formed.
...
#' @param continuous_assay_name,count_assay_name the names of the assays that are used for the statistical
#'   test. By default, `continuous_assay_name`  is  the name that was specified in the original `lemur()` call
#'   and `count_assay_name`, which is used if `test_method` is `"glmGamPoi"` or `"edgeR"`, is `"counts"`.
